<?php
  require "../includes/config.php";
                ...
                $total_count_q = mysqli_query($connection,"SELECT COUNT(`id`) AS `total_count` FROM `courses` WHERE `categorie_id` = $categorie");
                ...
                $articles = mysqli_query($connection,"SELECT * FROM `courses` WHERE `categorie_id` = $categorie ORDER BY `id` DESC LIMIT $offset,$per_page");
                $articles_exist = true;
